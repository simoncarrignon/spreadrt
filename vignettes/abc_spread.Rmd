...
![dens](../../doc/images/random_model/density_bothscore.png)

And we see how both distances are correlated

![cor](../../doc/images/random_model/correlation_bothscore.png)
...
![all-posterior](../../doc/images/random_model/posterior_distrib.png)
...
![mu-posterior](../../doc/images/random_model/mu_distrib.png)
...
![corel-param-ru](../../doc/images/random_model/param_corel_rumor.png)

![corel-param-ca](../../doc/images/random_model/param_corel_ca.png)
...
![rumors](../../doc/images/random_model/rumors_postcheck.png)

check the best set of parameters

![rumors-best](../../doc/images/random_model/rumors_best_postcheck.png)

check the median of the distribution of parameters

![rumors-median](../../doc/images/random_model/rumors_median_postcheck.png)
...
![cascades](../../doc/images/random_model/cascades_postcheck.png)

check the best set of parameters

![cascades-best](../../doc/images/random_model/cascades_best_postcheck.png)

check the median of the distribution of parameters

![cascades-median](../../doc/images/random_model/cascades_median_postcheck.png)
...
We know that the classes for the beta value of the agent are : `prior_beta`  = `r prior_beta`
...
save(file="spread/data/scores.ext.3D.rda",scores.ext)
build_vignettes("spread/")
```
...
![dens](../../doc/images/3D_model/density_scores_3D.png)

And we see how both distances are correlated

![cor](../../doc/images/3D_model/correlation_scores_3D.png)
...
<!--![all-posterior](../../doc/images/3D_model/posterior_distrib_3D.png)-->

In those representation the red distribution represent the prior distribution, the blue one the posterior for the model compared to the rumors size and the yellow one the model when compared to the cascades size

Du to it's strong impact on both model we redraw the graph for the posteriors of $lambda_c$:

![mu-posterior](../../doc/images/3D_model/lambda_c_distrib_3D.png)
![mu-posterior](../../doc/images/3D_model/N_distrib_3D.png)
![mu-posterior](../../doc/images/3D_model/Nmax_distrib_3D.png)
![mu-posterior](../../doc/images/3D_model/R_distrib_3D.png)
![mu-posterior](../../doc/images/3D_model/IC_distrib_3D.png)
![mu-posterior](../../doc/images/3D_model/dtime_distrib_3D.png)
![mu-posterior](../../doc/images/3D_model/stime_distrib_3D.png)
![mu-posterior](../../doc/images/3D_model/captl_distrib_3D.png)
![mu-posterior](../../doc/images/3D_model/repetition_distrib_3D.png)

The utility distribution
![mu-posterior](../../doc/images/3D_model/utility.1_distrib_3D.png)
![mu-posterior](../../doc/images/3D_model/utility.2_distrib_3D.png)
![mu-posterior](../../doc/images/3D_model/utility.3_distrib_3D.png)

The betas of the people 
![mu-posterior](../../doc/images/3D_model/betaDistrib.1_distrib_3D.png)
![mu-posterior](../../doc/images/3D_model/betaDistrib.2_distrib_3D.png)
![mu-posterior](../../doc/images/3D_model/betaDistrib.3_distrib_3D.png)
![mu-posterior](../../doc/images/3D_model/betaDistrib.4_distrib_3D.png)
![mu-posterior](../../doc/images/3D_model/betaDistrib.5_distrib_3D.png)


we can also check if some parameters are correlated:

![corel-param-ru](../../doc/images/3D_model/parametercorrelation_kc_size.png)
![corel-param-ru](../../doc/images/3D_model/parametercorrelation_kc_depth.png)
![corel-param-ru](../../doc/images/3D_model/parametercorrelation_kc_breadth.png)
